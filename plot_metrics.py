...
#ACC_TRAIN
Accuracy_train1 = np.load("/home/nick/CL13/ImportanceSampling-ex13/metrics_unif-SGD_cifar10_randaugment_b02/accuracy_per_epoch_train.npy")
...
plt.savefig("/home/nick/C10B2P001/resultsforacctrain.png")

# Reset the figure to create a new independent graph for test accuracy
plt.figure()

#ACC_TEST
Accuracy_test1 = np.load("/home/nick/CL13/ImportanceSampling-ex13/metrics_unif-SGD_cifar10_randaugment_b02/accuracy_per_epoch_val.npy")
...
plt.show()
# Save the plot to a file (e.g., PNG)
plt.savefig("/home/nick/C10B2P001/resultsforacctest.png")

# Reset the figure to create a new independent graph for test accuracy
plt.figure()

#LOSS_TRAIN
Loss_train1 = np.load("/home/nick/CL13/ImportanceSampling-ex13/metrics_unif-SGD_cifar10_randaugment_b02/LOSS_epoch_train.npy")
...
plt.show()
# Save the plot to a file (e.g., PNG)
plt.savefig("/home/nick/C10B2P001/resultsforlosstrain.png")

# Reset the figure to create a new independent graph for test accuracy
plt.figure()

#LOSS_TEST
Loss_test1 = np.load("/home/nick/CL13/ImportanceSampling-ex13/metrics_unif-SGD_cifar10_randaugment_b02/LOSS_epoch_val.npy")
...
plt.show()
# Save the plot to a file (e.g., PNG)
plt.savefig("/home/nick/C10B2P001/resultsforlosstest.png")
